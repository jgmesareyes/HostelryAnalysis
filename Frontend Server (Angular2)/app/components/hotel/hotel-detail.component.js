...
var HotelDetailComponent = (function () {
    function HotelDetailComponent(hostelryService, route, location) {
    ...
    HotelDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .switchMap(function (params) { return _this.hostelryService.getHotel(params['name']); })
            .subscribe(function (hotel) { return _this.hotel = hotel; });
    };
    HotelDetailComponent.prototype.showReviews = function () {
    ...
    HotelDetailComponent.prototype.showFacilities = function () {
